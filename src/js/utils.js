...
*/
MTRK.namespace = function(ns_string) {
...
MTRK.namespace("topics");
MTRK.namespace("globals");
MTRK.namespace("_UTILS_");
MTRK.namespace("_EVENTS_");
MTRK.namespace("MSGS");
...
MTRK.MSGS = {
	...
	"form": {
		"success": "Grazie per il lorem ipsum"
	}
};
...
(function(app, w, d){
	...
	app._UTILS_ = {
		...
		*/
		 ...
		 * @return {Function}
		 * @example
		 * 	MTRK._UTILS_.debounce(function, rate)();
		 */
		 ...
		 * @return {Boolean}
		 * @example:
		 * MTRK._UTILS_.isVisible($("#main-header"));
		 */
...
MTRK.AreaIdentifier = (function(w){
 ...
 */
MTRK.QueryData = (function(app, areaIdentifier){
	 ...
	 * @example
	 * MTRK.QueryData.query("GET_BRAND", {data: data});
	 */
	 ...
	 * @example
	 * MTRK.QueryData.queryChain([
	 *		MTRK.QueryData.query({
	 *			url: "/path"
	 *		}),
	 *		MTRK.QueryData.query({
	 *			url: "/path"
...
})(MTRK, MTRK.AreaIdentifier); // end QueryData()
 ...
 * @return {Object}       Public API
 */
MTRK.createShareURL = (function(w, msgs){
...
MTRK.sanitizeString = function(str){
 ...
 * @return {Object}             Public API
 */
MTRK.HtmlTemplates = (function(app) {
 ...
 * previously shown with MTRK.loading().
 */
MTRK.loaded = function() {
...
/**
  ...
  *
*/
MTRK.scrollToPos = function scrollToPos(opt) {
