<template>
  <div class="form-wrapper">
		<form id="form-partecipate" name="form-partecipate" action="/" method="POST" @submit.prevent="onSubmit">
									<h2 class="heading heading--sec heading--branded">Participate now!</h2>
									<div class="form__row layout palm-layout--stacked" role="group">
										<input placeholder="Name" name="name" v-model="name"
											v-validate="{ required: true }" v-bind:class="{'error': errors.has('name') }"
                      type="text" class="form__el layout__item">
										<input placeholder="Surname" name="surname" v-validate="{ required: true }" 
                      v-bind:class="{ 'error': errors.has('surname') }"
                      type="text" class="form__el layout__item">
										<input placeholder="E-mail" name="email" type="email"
										  v-validate="{ required: true, email: true }" v-bind:class="{'error': errors.has('email') }" class="form__el layout__item" >
									</div>
									<div class="form__row layout palm-layout--stacked" role="group">
                        ...
                        {{ option.text }}
										...
										<div class="layout__item">
											<div class="layout layout__item--datesection">
												<select required aria-label="Day" name="birthday-day" id="day"
												...
												<select required aria-label="Month" name="birthday-month" id="month"
												...
												<select required aria-label="Year" name="birthday-year" id="year"
									...
									<div class="form__row layout palm-layout--stacked" role="group">
										<div class="layout__item">
											<input placeholder="Project name" name="project-name" type="text"
											       class="form__el mb">
											<select name="project-category" id="project-category" class="form__el mb">
										...
										<textarea placeholder="Project description"
										          name="project-desc" id="project-desc" class="form__el layout__item"
										...
										<div class="layout__item">
											<div class="layout layout--stacked">
												...
												<aside id="privacy-info" class="privacy">
													...
													<p>
														Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias aliquam atque culpa, laborum, nam nisi placeat praesentium reiciendis.
													</p>
												</aside>
...
<script>
// TODO: Moment JS need to include for Date selection
			...
			onSubmit() {
				this.$validator.validateAll()
					.then(function(valid){
						...
						.then(response => {
								alert("API is success, but mock api so its failed!")
...
<style scoped>
	@import 'src/css/participate.scss';  
</style>